    ...
    switch (_function#1) do {
        case "GetMarkerTypes": {
...

            {
                ...
                private _markerTypeInfo = [_name, _color, _size, _icon, _shadow];
            ...
            private _markerColors = [];
            {
                ...
                private _markerTypeInfo = [_name, _color];
                _markerTypes pushBack (_markerTypeInfo joinString toString[10]);
            ...
            private _markerBrushes = [];
            {
                ...
                private _drawBorder = getNumber (_x >> "texture");

                private _markerTypeInfo = [_name, _texture, _drawBorder];
                _markerBrushes pushBack (_markerTypeInfo joinString toString[10]);

            } forEach ("getNumber (_x >> 'scope') == 2" configClasses (configFile >> "CfgMarkerBrushes"));
