...
{
    // https://github.com/Mapsui/Mapsui/blob/a9c28e1f111605775881fa57382f7142b5c2ade9/Mapsui.Rendering.Skia/BitmapRenderer.cs
    ...
    {        // The field below is static for performance. Effect has not been measured.
        ...
        {
            if (Math.Abs(layerOpacity - 1) > Mapsui.Utilities.Constants.Epsilon)
            {
